...
PASSAGE_PROB_DOOR = 0.2
PASSAGE_IS_DOOR = 0.2
PASSAGE_CREATION_CHANCE = 0.2
...
BLOCKS_PER_CONTENT_SLOT = 9

# For Hallways:
HALLWAY_ITEM_CHANCE = 0.05
HALLWAY_ENCOUNTER_CHANCE = 0.05
HALLWAY_OBSTACLE_COST = 100

# For Walls:
WALL_DECORATION_CHANCE = 0.1

# For PDF Generation:
PDF_BLOCK_SIZE_MM = 6.35
PDF_LEGEND_VERTICAL_SPACING = 30
PDF_LEGEND_HORIZONTAL_SPACING = 10